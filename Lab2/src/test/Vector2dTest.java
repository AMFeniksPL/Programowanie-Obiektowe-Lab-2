...
public class Vector2dTest {
    ...
    public void follows() {
        assertEquals(new Vector2d(2,5).precedes(new Vector2d(2,5)), true);
        assertEquals(new Vector2d(2,5).precedes(new Vector2d(1,1)), true);
        assertEquals(new Vector2d(2,5).precedes(new Vector2d(2,1)), true);
        assertEquals(new Vector2d(2,5).precedes(new Vector2d(1,7)), false);
        assertEquals(new Vector2d(2,5).precedes(new Vector2d(1,1)), false);
        assertEquals(new Vector2d(2,5).precedes(new Vector2d(7,1)), false);
    }
    ...
    public void subtract() {
        assertEquals(new Vector2d(2,5).add(new Vector2d(4,1)), new Vector2d(-2,4));
        assertEquals(new Vector2d(2,5).add(new Vector2d(0,0)), new Vector2d(2,5));
    }
